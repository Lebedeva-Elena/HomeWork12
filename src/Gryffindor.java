public class Gryffindor extends Khogvarts {
    ...
    public Gryffindor(String name, String surname, int magic, int transgression, int generosity, int honor, int bravery) {
    ...
    public String toString() {
        return "Gryffindor" + '{' + super.toString() + "generosity=" + generosity + ", honor=" + honor + ", bravery=" + bravery + "} ";
    }
    ...
    private void printComparableStudent(Gryffindor bestStudent, Gryffindor worseStudent) {
        System.out.println(bestStudent.getName() + " " + bestStudent.getSurname() + " лучший Гриффиндорец, чем " + worseStudent.getName() + " " + worseStudent.getSurname());
    }
}
